    ...
    public class OrderController : Controller
    {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                for (int i = 1; i <= data.Count; i++)
                {
                    ...
                    for (int t = 0; t < item.TicketInOrders.Count; t++)
                    {
                        ...
                        worksheet.Cell(i + 1, t + 3).Value = item.TicketInOrders.ElementAt(t).SelectedTicket.MovieName;
                    }
                }
        ...
        public FileContentResult CreateInvoice(Guid id)
        {
            ...
            foreach (var item in data.TicketInOrders)
            {
                ...
                sb.AppendLine(item.SelectedTicket.MovieName + " with ticket time: " + item.SelectedTicket.MovieTime + ", with quantity of: " + item.Quantity + " and price of: " + item.SelectedTicket.MoviePrice);
            }
